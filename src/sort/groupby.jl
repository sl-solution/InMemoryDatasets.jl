function groupby!(ds::Dataset, cols::MultiColumnIndex; rev = false, issorted::Bool = false, mapformats::Bool = true, stable = false)
...
groupby!(ds::Dataset, col::ColumnIndex; rev = false, issorted::Bool = false, mapformats::Bool = true, stable = false) = groupby!(ds, [col]; rev = rev, issorted = issorted, mapformats = mapformats, stable = stable)
...
function groupby(ds::Dataset, cols::MultiColumnIndex; rev = false, mapformats::Bool = true, stable = false)
...
groupby(ds::Dataset, col::ColumnIndex; rev = false, mapformats::Bool = true, stable = false) = groupby(ds, [col], rev = rev, mapformats = mapformats, stable = stable)
