...
Base.convert(T, col1::SubOrDSCol) = convert(T, __!(col1))
Base.convert(::Type{Any}, col1::SubOrDSCol) = convert(Any, __!(col1))
...
Base.argmax(f, col::SubOrDSCol) = argmax(f, __!(col))
Base.argmax(col::SubOrDSCol) = argmax(identity, __!(col))
Base.argmin(f, col::SubOrDSCol) = argmin(f, __!(col))
Base.argmin(col::SubOrDSCol) = argmin(identity, __!(col))
