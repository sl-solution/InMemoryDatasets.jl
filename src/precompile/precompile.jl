...
function _precompile()
    VERSION >= v"1.8" || return nothing
        ...
        Base.precompile(Tuple{Core.kwftype(typeof(flatten!)),NamedTuple{(:threads,), Tuple{Bool}},typeof(transpose),Dataset,UnitRange{Int64}})
        Base.precompile(Tuple{Core.kwftype(typeof(flatten!)),NamedTuple{(:threads,), Tuple{Bool}},typeof(transpose),Dataset,Int})
